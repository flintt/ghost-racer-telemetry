...
- **Road ends are welded**: when two roads end within a road-width plus 4 m of each other and within 2.5 m of height, the gap is closed. A bridge deck is its own object and the road either side of it often stops short; the height test is what stops an overpass being welded to the road running underneath it.
